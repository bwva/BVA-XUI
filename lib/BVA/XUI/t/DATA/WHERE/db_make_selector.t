...
__END__
1,last=jones AND (city=Capitola OR zip=95010) OR ?=whatever
1,last=smith AND (city=Santa Cruz OR zip=95060) OR last=jones AND (city=Capitola OR zip=95010) OR ?=whatever

1,(last=smith AND (city=Santa Cruz OR zip=95060)) OR (last=jones AND (city=Capitola OR zip=95010)) OR ?=whatever
1,(city=Santa Cruz OR zip=95060) OR last=jones AND (city=Capitola OR zip=95010)
1,(city+=santa Cruz OR city+=capitola) AND lastname=smith
...
1,last=smith AND city=santa Cruz AND address+ ^ H 
...
1,((last = smith AND (city = Santa Cruz OR zip = 95060)) OR (last = jones AND (city = Capitola OR zip = 95010)) OR ? = whatever)
1,(last=smith AND (city=Santa Cruz AND (zip=95060 OR zip=95062))) OR (last=jones AND (city=Capitola OR zip=95010)) OR ?=whatever
1,(last=smith AND (city=Santa Cruz AND (zip=95060 OR zip=95062))) OR (last=jones AND (city=Capitola OR zip=95010)) OR ?=whatever
1,(last=smith AND (city=Santa Cruz OR (zip=95060 OR zip=95062))) AND (last=jones AND (city=Capitola OR zip=95010)) OR ?=whatever
1,(last=smith AND (city=Santa Cruz OR zip=95060)) OR (last=jones AND (city=Capitola OR zip=95010)) OR ?=whatever
1,(last=smith AND (city=Santa Cruz OR zip=95060)) OR (last=jones AND city=Capitola) OR ?=whatever
1,last=smith AND (city=Santa Cruz OR zip=95060)
1,last=smith AND (city=Santa Cruz OR zip=95060) OR ?=whatever
