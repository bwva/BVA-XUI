...
package BVA::XUI::DATA::WHERE::Parser;
{ my $ERRORS;


package Parse::RecDescent::_Runtime::BVA::XUI::DATA::WHERE::Parser;
use strict;
use vars qw($skip $AUTOLOAD  );
@Parse::RecDescent::_Runtime::BVA::XUI::DATA::WHERE::Parser::ISA = ();
$skip = '\s*';
...
local $SIG{__WARN__} = sub {0};
# PRETEND TO BE IN Parse::RecDescent::_Runtime NAMESPACE
*Parse::RecDescent::_Runtime::BVA::XUI::DATA::WHERE::Parser::AUTOLOAD   = sub
{
    no strict 'refs';

    ${"AUTOLOAD"} =~ s/^Parse::RecDescent::_Runtime::BVA::XUI::DATA::WHERE::Parser/Parse::RecDescent::_Runtime/;
    goto &{${"AUTOLOAD"}};
}
}

push @Parse::RecDescent::_Runtime::BVA::XUI::DATA::WHERE::Parser::ISA, 'Parse::RecDescent::_Runtime';
# ARGS ARE: ($parser, $text; $repeating, $_noactions, \@args, $_itempos)
sub Parse::RecDescent::_Runtime::BVA::XUI::DATA::WHERE::Parser::word
{
	my $thisparser = $_[0];
	use vars q{$tracelevel};
	local $tracelevel = ($tracelevel||0)+1;
    ...
    Parse::RecDescent::_Runtime::_trace(q{Trying rule: [word]},
                  Parse::RecDescent::_Runtime::_tracefirst($_[1]),
                  q{word},
                  $tracelevel)
                    if defined $::RD_TRACE;
    ...
    my $lastsep;
    my $current_match;
    my $expectation = new Parse::RecDescent::_Runtime::Expectation(q{/[^()]+[:=><~!^#*@]\{1,2\}\\([^()]+\\)/, or /[^()]+/});
    $expectation->at($_[1]);
    ...
    while (!$_matched && !$commit)
    {
        ...
        Parse::RecDescent::_Runtime::_trace(q{Trying production: [/[^()]+[:=><~!^#*@]\{1,2\}\\([^()]+\\)/]},
                      Parse::RecDescent::_Runtime::_tracefirst($_[1]),
                      q{word},
                      $tracelevel)
                        if defined $::RD_TRACE;
        ...
        Parse::RecDescent::_Runtime::_trace(q{Trying terminal: [/[^()]+[:=><~!^#*@]\{1,2\}\\([^()]+\\)/]}, Parse::RecDescent::_Runtime::_tracefirst($text),
                      q{word},
                      $tracelevel)
                        if defined $::RD_TRACE;
        undef $lastsep;
        ...
        Parse::RecDescent::_Runtime::_trace(q{>>Matched production: [/[^()]+[:=><~!^#*@]\{1,2\}\\([^()]+\\)/]<<},
                      Parse::RecDescent::_Runtime::_tracefirst($text),
                      q{word},
                      $tracelevel)
                        if defined $::RD_TRACE;
...
# ARGS ARE: ($parser, $text; $repeating, $_noactions, \@args, $_itempos)
sub Parse::RecDescent::_Runtime::BVA::XUI::DATA::WHERE::Parser::item
{
	my $thisparser = $_[0];
	use vars q{$tracelevel};
	local $tracelevel = ($tracelevel||0)+1;
	$ERRORS = 0;
    my $thisrule = $thisparser->{"rules"}{"item"};

    Parse::RecDescent::_Runtime::_trace(q{Trying rule: [item]},
                  Parse::RecDescent::_Runtime::_tracefirst($_[1]),
                  q{item},
                  $tracelevel)
                    if defined $::RD_TRACE;
    ...
    my $lastsep;
    my $current_match;
    my $expectation = new Parse::RecDescent::_Runtime::Expectation(q{'(', or word, or /(?<! [[:punct:]])\\(/});
    $expectation->at($_[1]);
    ...
    while (!$_matched && !$commit)
    {
        ...
        Parse::RecDescent::_Runtime::_trace(q{Trying production: ['(' list ')']},
                      Parse::RecDescent::_Runtime::_tracefirst($_[1]),
                      q{item},
                      $tracelevel)
                        if defined $::RD_TRACE;
        ...
        Parse::RecDescent::_Runtime::_trace(q{Trying subrule: [list]},
                  Parse::RecDescent::_Runtime::_tracefirst($text),
                  q{item},
                  $tracelevel)
                    if defined $::RD_TRACE;
        ...
        unless (defined ($_tok = Parse::RecDescent::_Runtime::BVA::XUI::DATA::WHERE::Parser::list($thisparser,$text,$repeating,$_noactions,sub { \@arg },undef)))
        {
            
            Parse::RecDescent::_Runtime::_trace(q{<<Didn't match subrule: [list]>>},
                          Parse::RecDescent::_Runtime::_tracefirst($text),
                          q{item},
                          $tracelevel)
                            if defined $::RD_TRACE;
        ...
        Parse::RecDescent::_Runtime::_trace(q{>>Matched subrule: [list]<< (return value: [}
                    . $_tok . q{]},
        ...
        Parse::RecDescent::_Runtime::_trace(q{>>Matched production: ['(' list ')']<<},
                      Parse::RecDescent::_Runtime::_tracefirst($text),
                      q{item},
                      $tracelevel)
                        if defined $::RD_TRACE;
    ...
    while (!$_matched && !$commit)
    {
        ...
        Parse::RecDescent::_Runtime::_trace(q{Trying production: [word /(AND|OR)/ '(' list ')']},
                      Parse::RecDescent::_Runtime::_tracefirst($_[1]),
                      q{item},
                      $tracelevel)
                        if defined $::RD_TRACE;
        ...
        Parse::RecDescent::_Runtime::_trace(q{Trying subrule: [word]},
                  Parse::RecDescent::_Runtime::_tracefirst($text),
                  q{item},
                  $tracelevel)
                    if defined $::RD_TRACE;
        if (1) { no strict qw{refs};
        $expectation->is(q{})->at($text);
        unless (defined ($_tok = Parse::RecDescent::_Runtime::BVA::XUI::DATA::WHERE::Parser::word($thisparser,$text,$repeating,$_noactions,sub { \@arg },undef)))
        {
            
            Parse::RecDescent::_Runtime::_trace(q{<<Didn't match subrule: [word]>>},
                          Parse::RecDescent::_Runtime::_tracefirst($text),
                          q{item},
                          $tracelevel)
                            if defined $::RD_TRACE;
        ...
        Parse::RecDescent::_Runtime::_trace(q{>>Matched subrule: [word]<< (return value: [}
                    . $_tok . q{]},
        ...
        Parse::RecDescent::_Runtime::_trace(q{Trying terminal: [/(AND|OR)/]}, Parse::RecDescent::_Runtime::_tracefirst($text),
                      q{item},
                      $tracelevel)
                        if defined $::RD_TRACE;
        undef $lastsep;
        ...
        $_tok = ($_noactions) ? 0 : do { [ @item[1,2], @{$item[4]} ]  };
        unless (defined $_tok)
        {
            Parse::RecDescent::_Runtime::_trace(q{<<Didn't match action>> (return value: [undef])})
                    if defined $::RD_TRACE;
        ...
        Parse::RecDescent::_Runtime::_trace(q{>>Matched production: [word /(AND|OR)/ '(' list ')']<<},
                      Parse::RecDescent::_Runtime::_tracefirst($text),
                      q{item},
                      $tracelevel)
                        if defined $::RD_TRACE;
    ...
    while (!$_matched && !$commit)
    {
        ...
        Parse::RecDescent::_Runtime::_trace(q{Trying production: [word /(?<! [[:punct:]])\\(/ list ')']},
                      Parse::RecDescent::_Runtime::_tracefirst($_[1]),
                      q{item},
                      $tracelevel)
                        if defined $::RD_TRACE;
        ...
        Parse::RecDescent::_Runtime::_trace(q{Trying terminal: [/(?<! [[:punct:]])\\(/]}, Parse::RecDescent::_Runtime::_tracefirst($text),
                      q{item},
                      $tracelevel)
                        if defined $::RD_TRACE;
        undef $lastsep;
        ...
        unless ($text =~ s/\A($skip)/$lastsep=$1 and ""/e and   $text =~ m/\A(?:(?<! [[:punct:]])\()/)
        {
            $text = $lastsep . $text if defined $lastsep;
            $expectation->failed();
            Parse::RecDescent::_Runtime::_trace(q{<<Didn't match terminal>>},
        ...
        Parse::RecDescent::_Runtime::_trace(q{>>Matched production: [word /(?<! [[:punct:]])\\(/ list ')']<<},
                      Parse::RecDescent::_Runtime::_tracefirst($text),
                      q{item},
                      $tracelevel)
                        if defined $::RD_TRACE;
    ...
    while (!$_matched && !$commit)
    {
        ...
        $_tok = ($_noactions) ? 0 : do { [ @item[1,2], (@{$item[3]}==1 ? $item[3][0] : @{$item[3]}) ] };
        unless (defined $_tok)
        {
            Parse::RecDescent::_Runtime::_trace(q{<<Didn't match action>> (return value: [undef])})
                    if defined $::RD_TRACE;
    ...
    while (!$_matched && !$commit)
    {
        ...
        Parse::RecDescent::_Runtime::_trace(q{Trying production: [/(?<! [[:punct:]])\\(/ list ')']},
                      Parse::RecDescent::_Runtime::_tracefirst($_[1]),
                      q{item},
                      $tracelevel)
                        if defined $::RD_TRACE;
        ...
        $_tok = ($_noactions) ? 0 : do { [ $item{list} ] };
        unless (defined $_tok)
        {
            Parse::RecDescent::_Runtime::_trace(q{<<Didn't match action>> (return value: [undef])})
                    if defined $::RD_TRACE;
        ...
        Parse::RecDescent::_Runtime::_trace(q{>>Matched production: [/(?<! [[:punct:]])\\(/ list ')']<<},
                      Parse::RecDescent::_Runtime::_tracefirst($text),
                      q{item},
                      $tracelevel)
                        if defined $::RD_TRACE;
    ...
    while (!$_matched && !$commit)
    {
        ...
        Parse::RecDescent::_Runtime::_trace(q{Trying production: [word /(AND|OR)/ word]},
                      Parse::RecDescent::_Runtime::_tracefirst($_[1]),
                      q{item},
                      $tracelevel)
                        if defined $::RD_TRACE;
        ...
        $_tok = ($_noactions) ? 0 : do { [ @item[1,2,3] ] };
        unless (defined $_tok)
        {
            Parse::RecDescent::_Runtime::_trace(q{<<Didn't match action>> (return value: [undef])})
                    if defined $::RD_TRACE;
        ...
        Parse::RecDescent::_Runtime::_trace(q{>>Matched production: [word /(AND|OR)/ word]<<},
                      Parse::RecDescent::_Runtime::_tracefirst($text),
                      q{item},
                      $tracelevel)
                        if defined $::RD_TRACE;
    ...
    while (!$_matched && !$commit)
    {
        ...
        Parse::RecDescent::_Runtime::_trace(q{Trying production: [word]},
                      Parse::RecDescent::_Runtime::_tracefirst($_[1]),
                      q{item},
                      $tracelevel)
                        if defined $::RD_TRACE;
        ...
        $_tok = ($_noactions) ? 0 : do { $item{word} };
        unless (defined $_tok)
        {
            Parse::RecDescent::_Runtime::_trace(q{<<Didn't match action>> (return value: [undef])})
                    if defined $::RD_TRACE;
        ...
        Parse::RecDescent::_Runtime::_trace(q{>>Matched production: [word]<<},
                      Parse::RecDescent::_Runtime::_tracefirst($text),
                      q{item},
                      $tracelevel)
                        if defined $::RD_TRACE;
...
# ARGS ARE: ($parser, $text; $repeating, $_noactions, \@args, $_itempos)
sub Parse::RecDescent::_Runtime::BVA::XUI::DATA::WHERE::Parser::list
{
	my $thisparser = $_[0];
	use vars q{$tracelevel};
	local $tracelevel = ($tracelevel||0)+1;
    ...
    Parse::RecDescent::_Runtime::_trace(q{Trying rule: [list]},
                  Parse::RecDescent::_Runtime::_tracefirst($_[1]),
                  q{list},
                  $tracelevel)
                    if defined $::RD_TRACE;
    ...
    my $lastsep;
    my $current_match;
    my $expectation = new Parse::RecDescent::_Runtime::Expectation(q{<leftop: item /(AND|OR)/ item>});
    $expectation->at($_[1]);
    ...
    while (!$_matched && !$commit)
    {
        ...
        Parse::RecDescent::_Runtime::_trace(q{Trying production: [<leftop: item /(AND|OR)/ item>]},
                      Parse::RecDescent::_Runtime::_tracefirst($_[1]),
                      q{list},
                      $tracelevel)
                        if defined $::RD_TRACE;
        ...
        Parse::RecDescent::_Runtime::_trace(q{Trying operator: [<leftop: item /(AND|OR)/ item>]},
                  Parse::RecDescent::_Runtime::_tracefirst($text),
                  q{list},
                  $tracelevel)
                    if defined $::RD_TRACE;
        ...
        Parse::RecDescent::_Runtime::_trace(q{Trying subrule: [item]},
                  Parse::RecDescent::_Runtime::_tracefirst($text),
                  q{list},
                  $tracelevel)
                    if defined $::RD_TRACE;
        if (1) { no strict qw{refs};
        $expectation->is(q{item})->at($text);
        unless (defined ($_tok = Parse::RecDescent::_Runtime::BVA::XUI::DATA::WHERE::Parser::item($thisparser,$text,$repeating,$_noactions,sub { \@arg },undef)))
        {
            
            Parse::RecDescent::_Runtime::_trace(q{<<Didn't match subrule: [item]>>},
                          Parse::RecDescent::_Runtime::_tracefirst($text),
                          q{list},
                          $tracelevel)
                            if defined $::RD_TRACE;
        ...
        Parse::RecDescent::_Runtime::_trace(q{>>Matched subrule: [item]<< (return value: [}
                    . $_tok . q{]},
        ...
        unless ($repcount>=1)
        {
            Parse::RecDescent::_Runtime::_trace(q{<<Didn't match operator: [<leftop: item /(AND|OR)/ item>]>>},
                          Parse::RecDescent::_Runtime::_tracefirst($text),
                          q{list},
                          $tracelevel)
                            if defined $::RD_TRACE;
        ...
        Parse::RecDescent::_Runtime::_trace(q{>>Matched operator: [<leftop: item /(AND|OR)/ item>]<< (return value: [}
                      . qq{@{$_tok||[]}} . q{]},
                      Parse::RecDescent::_Runtime::_tracefirst($text),
                      q{list},
                      $tracelevel)
        ...
        Parse::RecDescent::_Runtime::_trace(q{>>Matched production: [<leftop: item /(AND|OR)/ item>]<<},
                      Parse::RecDescent::_Runtime::_tracefirst($text),
                      q{list},
                      $tracelevel)
                        if defined $::RD_TRACE;
...
package BVA::XUI::DATA::WHERE::Parser; sub new { my $self = bless( {
                 'localvars' => '',
                 'startcode' => '',
                 'namespace' => 'Parse::RecDescent::_Runtime::BVA::XUI::DATA::WHERE::Parser',
                 'rules' => {
                              'word' => bless( {
                                                 'impcount' => 0,
                                                 'calls' => [],
                                                              ...
                                                              bless( {
                                                                       ...
                                                                       'items' => [
                                                                                    ...
                                                                                    bless( {
                                                                                             ...
                                                                                             'lookahead' => 0,
                                                                                             'line' => 6,
                                                                                             'code' => '{ [ @item[1,2], (@{$item[3]}==1 ? $item[3][0] : @{$item[3]}) ] }'
                                                                                           }, 'Parse::RecDescent::_Runtime::Action' )
                                                                                  ],
                                                                       'line' => 6
                                                                     }, 'Parse::RecDescent::_Runtime::Production' ),
                              ...
                              'list' => bless( {
                                                 ...
                                                 'prods' => [
                                                              bless( {
                                                                       ...
                                                                       'items' => [
                                                                                    bless( {
                                                                                             'expected' => '<leftop: item /(AND|OR)/ item>',
                                                                                             'min' => 1,
                                                                                             'name' => '',
                                                                                             'max' => 100000000,
                                                                                             'leftarg' => bless( {
